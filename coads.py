...
calc_surf = Vasp(prec="normal", xc=xc, ispin=2, algo="VeryFast",pp=xc,
		 encut=400.0, ibrion=2, potim=potim, nsw=100, istart=0,
		 kpts=[3,3,1],
...
calc_mol = Vasp(prec="normal", xc=xc, ispin=1, algo="VeryFast",
		encut=400.0, ibrion=2, potim=potim, nsw=100, istart=0,
		kpts=[1,1,1],
		lreal=True, npar=12, nsim=12
	   )
